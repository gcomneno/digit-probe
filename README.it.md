> [!NOTE]
> This Italian document is a derived presentation copy.
> The authoritative source for the public package is [`README.md`](README.md), maintained in English.
> If the two documents differ, `README.md` is canonical.
